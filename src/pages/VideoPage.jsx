      ...
      >
        ...
        >
          <CardContent sx={{ p: 0 }}>
            {vurl ? (
              <CVPL
                url={'https://us-central1-dopamine-lite-b61bf.cloudfunctions.net/getPresignedUrl?manifest_key=index.m3u8&segment_keys=index0.ts,index1.ts&folder=' + handler + '&expiration=10800'}
