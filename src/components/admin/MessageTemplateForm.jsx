    ...
    return (
      <Bx>
        ...
        <Tf
          ...
          required
          helperText="Use {{placeholder}} for dynamic content. You can use Markdown: **bold**, *italic*, __underline__"
          InputProps={{
            startAdornment: (
        ...
        {/* Templates Management for Templates Tab
        {templates.length > 0 && (
          <Paper sx={{ mt: 3, p: 2 }}>
            <T variant="subtitle1" gutterBottom>Template Management</T>
            <Divider sx={{ mb: 2 }} />
            ...
            <Stack spacing={2}>
              {templates.map((template) => (
                ...
                >
                  <T variant="body1" noWrap sx={{ flex: 1 }}>{template.title}</T>
